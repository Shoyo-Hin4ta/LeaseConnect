...
const DateInput: React.FC<DateInputProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="flex dark:bg-gray-900 border rounded-lg items-center text-sm px-1">
      <input
        type="text"
        ref={monthRef}
        max={12}
        ...
        className="p-0 dark:bg-gray-900 outline-none w-6 border-none text-center"
        placeholder="M"
      />
      ...
      <input
        ...
        className="p-0 dark:bg-gray-900 outline-none w-7 border-none text-center"
        placeholder="D"
      />
      <span className="opacity-20 -mx-px">/</span>
      <input
        ...
        className="dark:bg-gray-900 p-0 outline-none w-12 border-none text-center"
        placeholder="YYYY"
      />
    </div>
  )
